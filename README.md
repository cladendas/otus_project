...
||Название|Описаение|
|-|-|-|
||Main|эндпоинты для post- и get-запросов, определение подходящего обработчика|
||Handler|обработчик запросов: проверка соответствия, проверка данных|
||Transformer|формирование целевой структуры|
||Sendler|отправка сформированного запроса по целевому пути|
||Logger|логирование: входящих запросов, обработки запросов, формирования запроса, статуса отправки и получения запроса|
||Exporter|сборк метрик|
